...
public class SapatilhasPremium extends Sapatilhas{ //nunca tem desconto mas aumenta o preço consoante os anos que ele tem
    ...
    public SapatilhasPremium(int numeroUtilizadores, Double estado, String descricao, String marca, Long codigoAlfa, Double precoBase, Double correcaoPreco, Double tamanho, Boolean atacadores, String cor, LocalDateTime dataLancamento, Double desconto) {
